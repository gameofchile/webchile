...
Candy.Achievements.prototype = {
	create: function() {
		...
		this.game.add.text(30, 250, "Voto Unico (vale 1 voto)", { font: "28px ComicBook", fill: "#FFFFFF" });
		this.game.add.text(30, 300, "Guillier (vale 2 votos)", { font: "28px ComicBook", fill: "#FFFFFF" });
		this.game.add.text(30, 350, "Ominami (vale 3 votos)", { font: "28px ComicBook", fill: "#FFFFFF" });
		this.game.add.text(30, 400, "Navarro (vale 4 votos)", { font: "28px ComicBook", fill: "#FFFFFF" });
		this.game.add.text(30, 450, "Sanchez (vale 5 votos)", { font: "28px ComicBook", fill: "#FFFFFF" });

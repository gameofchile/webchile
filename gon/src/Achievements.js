...
Candy.Achievements.prototype = {
	create: function() {
		...
		this.game.add.text(30, 400, "Sanchez (vale 4 votos)", { font: "28px ComicBook", fill: "#FFFFFF" });
		this.game.add.text(30, 450, "Artes (vale 5 votos)", { font: "28px ComicBook", fill: "#FFFFFF" });
